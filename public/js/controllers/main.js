...
angular.module('CmasR')
    .controller('MainController',['$scope','$rootScope','$location','$http',
            ...
            $http({headers:
            {
                ...
                .success(function(sessionResponse)
                {
                    ...
                    if(sessionResponse == "No data found")
                    {
                        ...
                        //console.log(sessionResponse.sessionEmail.toString().indexOf("@admin.com"));
                    }
...
// Table
        ...
        {
            //console.log("Picture id : "+$rootScope.userCredentials.picture_id);
            return pics[$rootScope.userCredentials.picture.toString()];
        };
